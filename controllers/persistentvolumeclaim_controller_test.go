...
var _ = Describe("PersistentVolumeClaimController controller", func() {
	...
	It("should delete PVC finalizer", func() {
		...
		Eventually(func() error {
			...
			expectedFinalizers := []string{"topolvm.io/finalizer1", "topolvm.io/finalizer3", "kubernetes.io/pvc-protection"}
...
func newPVCWithFinalizer() *corev1.PersistentVolumeClaim {
	return &corev1.PersistentVolumeClaim{
		ObjectMeta: metav1.ObjectMeta{
			Name:       "sample",
			Namespace:  "test",
			Finalizers: []string{"topolvm.io/finalizer1", topolvm.PVCFinalizer, "topolvm.io/finalizer3"},
		},
